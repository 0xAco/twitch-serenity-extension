...
function(e, t) {
  ...
  function O(e, t) {
    ...
    for (; e.next();) {
      ...
      t.isSymbol("(") && !i.length ? s.push(t) : t.isSymbol(")") && !i.length && s.pop(), t.isSymbol("'", '"') && ("open" === t.status ? i.push(t) : i.pop());
      let l = !i.length && !s.length && (!o || t.isSymbol(";") || o.isSymbol("}"));
      if (t.isSymbol("'", '"') && o && o.isSymbol("}") && !i.length && (l = !0), !s.length && !i.length && t.isSymbol("{")) {
        let t = H(r);
    ...
    return r.length && !n ? (t._valueTokens = r, t.value = B(r)) : n && (t.value = n), t.origin && (t.origin.value = t.value), t
  }
  ...
  function W(e, t) {
    ...
    for (; e.next();) {
      ...
      } else l.isSymbol(";") ? n.length && r.length && (n[n.length - 1].value += ";" + B(r), r = []) : r.push(l)
    }
    return n.length && V(i) && (t.value = n), i ? t : n
  }
  ...
  function G(e, t) {
    ...
    if ("block" === e.type) {
      ...
      if (e.times ? n += "@M" + e.times + "(" + e.pureName + "{" : n += e.name + (t ? " " : "{"), "style" === e.name) n += e.value;
        ...
        let t = "";
        for (let r of e.value) n += G(r, t), r.origin && (t = r.origin.name.join(","))
      }
      e.times ? n += "})" : t || (n += "}")
  ...
  function ce(e, t) {
    return ue((e => /[^\w@]/.test(e)))(e, t)
  }

  function he(e) {
    return ue((e => /[\s\{]/.test(e)))(e)
  }

  function pe(e, t) {
    return ue((e => ie.line_break(e) || "{" == e))(e, t)
  }

  function fe(e, t) {
    let n, r = re.step();
    for (; !e.end() && "}" != (n = e.curr());)
      if (ie.white_space(n)) e.next();
      else {
        if (r.name.length) {
  ...
  function me(e, t) {
    const n = [];
    let r;
    for (; !e.end() && "}" != (r = e.curr());) ie.white_space(r) || n.push(fe(e, t)), e.next();
    return n
  }

  function de(e, t) {
    let n, r = re.keyframes();
    for (; !e.end() && "}" != (n = e.curr());)
      if (r.name.length) {
        if ("{" == n || "{" == e.curr(-1)) {
          e.next(), r.steps = me(e, t);
          break
        }
        e.next()
      }
    else if (ce(e), r.name = he(e), !r.name.length) {
      ae("missing keyframes name", e.info());
      break
    }
    return r
  }
  ...
  function ye(e) {
    let t, n = "";
    for (; !e.end() && ":" != (t = e.curr());) ie.white_space(t) || (n += t), e.next();
    return n
  }
  ...
  function xe(e, t, n) {
    ...
    for (; !e.end();) {
      ...
      let h = e.curr(-1),
        p = e.index();
      if (/[\('"`]/.test(r) && "\\" !== h) o.length && "(" !== r && r === ee(o) ? o.pop() : o.push(r), l += r;
      else if (("@" == r || "." === h && t) && !n) s.length || (l = l.trimLeft()), l.length && (s.push(re.text(l)), l = ""), s.push(ke(e));
      else if (n && /[)]/.test(r) || !n && /[,)]/.test(r))
        if (o.length) ")" == r && "(" === ee(o) && o.pop(), l += r;
        else {
          if (l.length && (s.length ? /\S/.test(l) && s.push(re.text(l)) : s.push(re.text((c = l).trim().length ? ie.number(+c) ? +c : c.trim() : c)), l.startsWith("\xb1") && !n)) {
            let e = l.substr(1),
              t = (u = s, "undefined" != typeof structuredClone ? structuredClone(u) : JSON.parse(JSON.stringify(u)));
            ee(t).value = "-" + e, i.push(_e(t)), ee(s).value = e
          }
          if (i.push(_e(s)), [s, l] = [
              [], ""
            ], ")" == r) break
        }
      else se[r] && !/[0-9]/.test(e.curr(-1)) && (r = se[r]), l += r;
      if (!(!t || ")" != e.curr(1) && ";" != e.curr(1) && /[0-9a-zA-Z_\-.]/.test(e.curr()) || o.length)) {
        s.length && i.push(_e(s));
        break
      }
  ...
  function _e(e) {
    ...
    if ("text" == n.type && "text" == r.type) {
      let e = te(n.value),
        i = ee(r.value);
      "string" == typeof n.value && "string" == typeof r.value && ie.pair_of(e, i) && (n.value = n.value.slice(1), r.value = r.value.slice(0, r.value.length - 1), t.cluster = !0)
    }
    return t
  }
  ...
  function Se(e) {
    ...
    let o = [],
      l = [];
    for (; !e.end();)
      if (t = e.curr(), i && ie.white_space(t)) e.next();
      else {
        if (i = !1, "\n" != t || ie.white_space(e.curr(-1)))
          if ("," != t || o.length) {
            if (/[;}<]/.test(t) && !l.length) {
              n.value.length && (s[r].push(n), n = re.text());
              break
            }
            if ("@" == t && /\w/.test(e.curr(1))) n.value.length && (s[r].push(n), n = re.text()), s[r].push(ke(e));
            else if ('"' === t || "'" === t) {
              t === ee(l) ? l.pop() : l.length || l.push(t), n.value += t
            } else ie.white_space(t) && ie.white_space(e.curr(-1)) || ("(" == t && o.push(t), ")" == t && o.pop(), se[t] && !/[0-9]/.test(e.curr(-1)) && (t = se[t]), n.value += t)
          }
        else n.value.length && (s[r].push(n), n = re.text()), s[++r] = [], i = !0;
        else n.value += " ";
  ...
  function Ae(e, t) {
    ...
    for (; !e.end();) {
      if (n = e.curr(), "/" == n && "*" == e.curr(1)) ge(e);
        ...
        if (r.selector) {
          let n = Ee(e, t);
          if ("@use" == n.property ? r.styles = r.styles.concat(n.value) : n.property && r.styles.push(n), "}" == e.curr()) break
        } else r.selector = je(e)
      }
      e.next()
    }
    return r
    ...
    e.forEach && e.forEach((e => {
      if ("text" == e.type && e.value) {
        ...
        e.value = n.reduce(((e, n) => {
          let r, i = "",
            s = "";
          i = Ne(t, n.name), !i && n.fallback && n.fallback.every((e => {
            if (s = Ne(t, e.name), s) return i = s, !1
          }));
          try {
            r = ze(i, t)
          } catch (e) {}
  ...
  function ze(e, t) {
    ...
    for (; !n.end();) {
      let e = n.curr();
      if (ie.white_space(e)) n.next();
      else {
        if ("/" == e && "*" == n.curr(1)) ge(n);
        else if (":" == e) {
          let e = Ae(n, t);
          e.selector && r.push(e)
        } else if ("@" == e && "@keyframes" === ce(n, !0)) {
          let e = de(n, t);
          r.push(e)
        } else if ("@" != e || pe(n, !0).includes(":")) {
          if ("<" == e) ve(n);
          else if (!ie.white_space(e)) {
            let e = Ee(n, t);
            e.property && r.push(e)
          }
        } else {
  ...
  function We(e) {
    return Ie(e).map((e => e.value)).join("")
  }
  ...
  class Fe {
    ...
    toString() {
      if (this.isTextNode()) return He(this.body);
      let e = [""],
        t = [];
      for (let [t, n] of Object.entries(this.attrs)) n = He(n), e.push(`${t}="${n}"`);
  ...
  function Xe(e, t, n, r) {
    let i;
    if (t || (t = new Fe("root")), "block" === e.type)
      if ("style" === e.name) {
        let n = new Fe("style");
    ...
    if ("statement" === e.type && !e.variable)
      if ("content" === e.name) {
        let n = new Fe("text-node", e.value);
        t.append(n)
      }
  ...
  function Qe(e, t, n = []) {
    ...
    for (; e.length;) {
      ...
      if ("variable" === o) {
        let e = t[s];
        w(e) && (e = Math[s]), w(e) && (e = nt(s, t, n)), w(e) && /^\-\D/.test(s) && (e = nt("-1" + s.substr(1), t, n)), void 0 === e && (e = 0), "number" != typeof e && (n.push(e), rt(n) ? (e = 0, n = []) : e = Qe(et(e), t, n)), r.push(e)
      } else if ("function" === o) {
        let e = !1;
        /^\-/.test(i) && (e = !0, i = i.substr(1));
        let o, l = s.map((e => Qe(e, t, n))),
          a = i.split(".");
        for (; o = a.pop();) {
          if (!o) continue;
          let e = t[o] || Math[o];
  ...
  function et(e) {
    ...
    for (let e = 0; e < t.length; ++e) {
      ...
      if ("number" == i)
        ...
        for (; n.length && "(" != ee(n);) r.push({
          type: "operator",
          value: n.pop()
        });
        n.pop()
      } else {
        for (; n.length && Ke[ee(n)] >= Ke[s];) {
          let e = n.pop();
          /[()]/.test(e) || r.push({
            type: "operator",
            value: e
  ...
  function nt(e, t, n) {
    let [r, i, s] = e.match(/([\d.\-]+)(.*)/) || [], o = t[s];
    return void 0 === o ? o : "number" == typeof o ? Number(i) * o : (n.push(o), rt(n) ? (n = [], 0) : i * Qe(et(o), t, n))
  }
  ...
  function it(e, t) {
    return Qe(et(e), Object.assign({}, Je, t))
  }
  var st = new class {
    constructor() {
      this.cache = {}
  ...
  const at = ot("build_range", (e => {
    let t = function(e) {
      ...
      for (let e = 1; e < t.length - 1; ++e) {
        ...
        if ("-" != i || "-" != t[e - 1])
          if ("-" != i)
            if ("-" != ee(r)) r.length && n.push(lt("char", r.pop())), r.push(i);
            else {
              r.pop();
              let e = r.pop();
              n.push(e ? lt("range", [e, i]) : lt("char", i))
            }
        else r.push(i)
      }
      return r.length && n.push(lt("char", r.pop())), n
    }(e);
    return ne(t, (({
      type: e,
      value: t
  ...
  function ut(e) {
    return (...t) => e(...ne(t, (e => String(e).startsWith("[") ? at(e) : e)))
  }
  class ct {
    constructor(e) {
  ...
  class pt {
    constructor() {
      var e;
      this.p = [].concat(e = [151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10, 23, 190, 6, 148, 247, 120, 234, 75, 0, 26, 197, 62, 94, 252, 219, 203, 117, 35, 11, 32, 57, 177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68, 175, 74, 165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 211, 133, 230, 220, 105, 92, 41, 55, 46, 245, 40, 244, 102, 143, 54, 65, 25, 63, 161, 1, 216, 80, 73, 209, 76, 132, 187, 208, 89, 18, 169, 200, 196, 135, 130, 116, 188, 159, 86, 164, 100, 109, 198, 173, 186, 3, 64, 52, 217, 226, 250, 124, 123, 5, 202, 38, 147, 118, 126, 255, 82, 85, 212, 207, 206, 59, 227, 47, 16, 58, 17, 182, 189, 28, 42, 223, 183, 170, 213, 119, 248, 152, 2, 44, 154, 163, 70, 221, 153, 101, 155, 167, 43, 172, 9, 129, 22, 39, 253, 19, 98, 108, 110, 79, 113, 224, 232, 178, 185, 112, 104, 218, 246, 97, 228, 251, 34, 242, 193, 238, 210, 144, 12, 191, 179, 162, 241, 81, 51, 145, 235, 249, 14, 239, 107, 49, 192, 214, 31, 181, 199, 106, 157, 184, 84, 204, 176, 115, 121, 50, 45, 127, 4, 150, 254, 138, 236, 205, 93, 222, 114, 67, 29, 24, 72, 243, 141, 128, 195, 78, 66, 215, 61, 156, 180], e)
    }
    grad(e, t, n, r) {
      let i = 15 & e,
        s = i < 8 ? t : n,
    ...
    noise(e, t, n) {
      ...
      return C(c, C(u, C(a, i(r[p], e, t, n), i(r[d], e - 1, t, n)), C(a, i(r[f], e, t - 1, n), i(r[g], e - 1, t - 1, n))), C(u, C(a, i(r[p + 1], e, t, n - 1), i(r[d + 1], e - 1, t, n - 1)), C(a, i(r[f + 1], e, t - 1, n - 1), i(r[g + 1], e - 1, t - 1, n - 1))))
    }
  }
  ...
  function mt(e) {
    ...
    for (; n.next();) {
      ...
      if (r.isSymbol(":") && !t) t = gt(s), s = [];
      else if (r.isSymbol(";") && t) i[t] = dt(t, gt(s), o), s = [], t = null, o = !1;
      else if (!r.isSymbol(";")) {
        let n = e && e.isSymbol("-"),
          i = l && l.isSymbol("-"),
          a = r.isSymbol("-");
    ...
    return s.length && t && (i[t] = dt(t, gt(s), o)), i
  }
  ...
  function xt(e) {
    ...
    for (; t.next();) {
      ...
      if (r.isWord() && vt.includes(r.value)) s.direction = r.value, n = !0;
      else if (r.isNumber()) s.angle = Number(r.value), n = !0;
      else if (r.isWord() && e && e.isNumber() && yt.includes(r.value)) i = r.value;
  ...
  const {
    ...
    circle: () => St`split:180;scale:.99`,
    triangle: () => St`rotate:30;scale:1.1;move:0 .2`,
    pentagon: () => St`split:5;rotate:54`,
    hexagon: () => St`split:6;rotate:30;scale:.98`,
    octagon: () => St`split:8;rotat:22.5;scale:.99`,
    star: () => St`split:10;r:cos(5t);rotate:-18;scale:.99`,
    infinity: () => St`split:180;scale:.99;x:cos(t)*.99 / (sin(t)^2 + 1);y:x * sin(t)`,
    heart: () => St`split:180;rotate:180;a:cos(t)*13/18 - cos(2t)*5/18;b:cos(3t)/18 + cos(4t)/18;x:(.75 * sin(t)^3) * 1.2;y:(a - b + .2) * -1.1`,
    bean: () => St`split:180;r:sin(t)^3 + cos(t)^3;move:-.35 .35;`,
    bicorn: () => St`split:180;x:cos(t);y:sin(t)^2 / (2 + sin(t)) - .5`,
    drop: () => St`split:180;rotate:90;scale:.95;x:sin(t);y:(1 + sin(t)) * cos(t) / 1.6`,
    fish: () => St`split:240;x:cos(t) - sin(t)^2 / sqrt(2) - .04;y:sin(2t)/2`,
    whale: () => St`split:240;rotate:180;R:3.4 * (sin(t)^2 - .5) * cos(t);x:cos(t) * R + .75;y:sin(t) * R * 1.2`,
    windmill: () => St`split:18;R:seq(.618, 1, 0);T:seq(t-.55, t, t);x:R * cos(T);y:R * sin(T)`,
    vase: () => St`split:240;scale:.3;x:sin(4t) + sin(t) * 1.4;y:cos(t) + cos(t) * 4.8 + .3`,
    clover: (e = 3) => (4 == (e = v(e, 3, 5)) && (e = 2), St`split:240;r:cos(${e}t);scale:.98`),
    hypocycloid: (e = 3) => (e = v(e, 3, 5), St`split:240;scale:${[0,0,0,.34,.25,.19][e]};k:${e};x:(k-1)*cos(t) + cos((k-1)*t);y:(k-1)*sin(t) - sin((k-1)*t)`),
    bud: (e = 3) => (e = v(e, 3, 10), St`split:240;scale:.8;r:1 + .2 * cos(${e}t)`)
  };
  class Tt {
    constructor(e, t, n) {
  ...
  function Rt(e, {
    ...
    return a && !e[a] && "t" !== a && ($(e.unit) && (e.unit = a), o = e.r = u), e.degree && (e.rotate = e.degree), e.origin && (e.move = e.origin),
      function(e, t) {
        "function" == typeof arguments[0] && (t = e, e = {}), t || (t = e => [bt(e), _t(e)]);
        let n, r, i = e.split || 180,
          s = e.turn || 1,
          o = e.frame,
          l = e.fill || e["fill-rule"],
          a = xt(e.direction || e.dir || ""),
          u = e.unit,
          c = 2 * kt * s / i,
          h = [],
          p = void 0 === e.scale ? 1 : e.scale,
          f = ([e, t, n = 0, r = 0]) => {
            if ("evenodd" == e || "nonzero" == e) return h.push(new Tt(e, "", ""));
            let [i, s] = Et(e, -t, p), [o, l] = Et(n, -r, p), c = At(i, s, o, l, a);
            void 0 !== u && "%" !== u ? "none" !== u && (i += u, s += u) : (i = 50 * (i + 1) + "%", s = 50 * (s + 1) + "%"), h.push(new Tt(i, s, c))
          };
        ...
        let a = Object.assign({}, e, {
            ...
            range: (e, t = 0) => ((e = Number(e) || 0) > (t = Number(t) || 0) && ([e, t] = [t, e]), e + wt(t - e) / (r - 1) * n)
          }),
          u = it(i, a),
          c = it(s, a),
          h = 0,
        ...
        if (o) {
          let e = it(o, a);
          0 == e && (e = 1e-5), l && (t = it(l, a)), u = e * bt(t), c = e * _t(t)
        }
        return e.rotate && ([u, c] = function(e, t, n) {
          let r = -kt / 180 * n;
          return [e * bt(r) - t * _t(r), t * bt(r) + e * _t(r)]
        }(u, c, Number(e.rotate) || 0)), e.move && ([u, c, h, p] = function(e, t, n) {
          let [r, i = r] = L(n).map(Number);
  ...
  Pt.animation = `\n ${Pt["animation-duration"]}ms\n ${Pt["animation-timing-function"]} ${Pt["animation-delay"]} ${Pt["animation-iteration-count"]} ${Pt["animation-name"]}`;
  const Ct = {
  ...
  function It(e) {
    return k(((t, n, ...r) => {
      ...
      let i = j(n()),
        s = i;
      /\D/.test(i) && !/\d+[x-]\d+/.test(i) && (s = it(i), 0 === s && (s = i));
      let o = Math.random();
      return function(e, t) {
  ...
  function Wt(e, t, n) {
    return e[t] || (e[t] = new ht), e[t].push(n), n
  }
        ...
        let n = t.substr(-1),
          {
            unit: r = "",
            value: i
          } = Ye(t.substr(0, t.length - 1).trim() || 0);
        return Bt(n, i, e) + r
      } {
        let {
          unit: n = "",
  ...
  const Ft = x({
      ...
      p: ({
        ...
        let r = t(n);
        return e.last_pick_args = n, Wt(e, "last_pick", r)
      })),
      P({
        context: e,
        pick: t,
        ...
        return ut(((...n) => {
          ...
          let l = t(n);
          return e.last_pick_args = n, i && (e[r].last_pick = l), Wt(e, "last_pick", l)
        }))
      },
      pl({
        context: e,
      ...
      r: ({
        ...
        let r = (n.every(b) ? Ze : Ve)(t)(...n);
        return Wt(e, "last_rand", r)
      },
      rn({
        x: e,
        y: t,
        ...
        return (...r) => {
          let {
            ...
            scale: y = 1,
            octave: x = 1
          } = ft(r, ["from", "to", "frequency", "scale", "octave"]);
          f = v(f, 0, 1 / 0), y = v(y, 0, 1 / 0), x = v(x, 1, 100), 1 == r.length && ([s, c] = [0, s]), n[l] || (n[l] = new pt), n[a] || (n[a] = o()), n[u] || (n[u] = o());
          let _ = b(s) && b(c) ? Ze : Ve,
            w = n[l],
            $ = n[a],
            k = n[u],
            S = (g ? (h - 1) / m : (e - 1) / i.x) + $,
            j = (g ? (p - 1) / d : (t - 1) / i.y) + k;
          (m <= 1 || i.x <= 1) && (S = 0), (d <= 1 || i.y <= 1) && (j = 0), 0 == S && 0 == j && (S = $, j = k);
          let T = w.noise(S * f, j * f, 0) * y;
          for (let e = 1; e < x; ++e) {
            let t = 2 * e;
            T += w.noise(S * f * t, j * f * t, 0) * (y / t)
          }
          let A = _(((e, t) => function(e, t, n, r = 1) {
            let i = Math.sqrt(.5) * r,
              [s, o] = [-i, i];
            return C((e - s) / (o - s), t * r, n * r)
          }(T, e, t, y)));
          return Wt(n, "last_rand", A(s, c))
        }
      },
      lr: ({
        context: e
      ...
      filter: k(((e, ...t) => {
        ...
        if (n.every((e => /^[\-\d.]/.test(e) || /^(\w+)/.test(e) && !/[{}<>]/.test(e)))) {
          let {
            ...
            erode: a,
            dilate: u
          } = ft(n, ["frequency", "scale", "octave", "seed", "blur", "erode", "dilate"]);
      ...
      plot({
        ...
        return n => {
          ...
          if (!t[s]) {
            let e = mt(n);
            delete e.fill, delete e["fill-rule"], delete e.frame, e.points = u, t[s] = Rt(e, {
              min: 1,
              max: 65536
            })
          }
      ...
      Plot({
        ...
        return n => {
          ...
          if (!t[s]) {
            let e = mt(n);
            delete e.fill, delete e["fill-rule"], delete e.frame, e.points = u, e.unit = e.unit || "none", t[s] = Rt(e, {
              min: 1,
              max: 65536
            })
          }
      ...
      shape: () => ot("shape-function", ((e = "", ...t) => {
        let n = [];
        if ((e = String(e).trim()).length)
          if ("function" == typeof jt[e]) n = jt[e](t);
          else {
            let r = e,
              i = t.join(",");
            i.length && (r = e + "," + i), n = Rt(mt(r), {
              min: 3,
              max: 3600
            })
      ...
      cycle: () => (...e) => {
        let t, n = [];
        1 == (e = e.map((e => "(" + e + ")"))).length ? (t = " ", n = L(e[0], {
          symbol: t
        })) : (t = ",", n = L(e.map(j).join(t), {
          symbol: t
  ...
  function Yt(e) {
    if (!qt.length) {
      ...
      e.has("grid-gap") || e.add("grid-gap"), qt = Array.from(e)
    }
    return e instanceof RegExp ? qt.filter((t => e.test(t))) : qt
  }

  function Vt(e) {
    let t = new RegExp(`\\-?${e}\\-?`);
    return Yt(t).map((e => e.replace(t, ""))).reduce(((e, t) => (e[t] = t, e)), {})
  }
  const Zt = Vt("webkit"),
    Gt = Vt("moz");

  function Jt(e, t) {
    return Zt[e] ? `-webkit-${t} ${t}` : Gt[e] ? `-moz-${t} ${t}` : t
  }
  const Kt = {
      center: "50%",
      left: "0%",
  ...
  var en = x({
    size(e, {
      ...
      let [r, i = r, s] = L(e);
      Ht[r] && ([r, i] = function(e, t) {
        e = String(e).toLowerCase();
        let [n, r] = Ht[e] || [];
        return "p" == Xt[t] && ([r, n] = [n, r]), [r, n].map((e => e + "mm"))
      }(r, i));
      let o = `\n width:${r};height:${i};`;
    ...
    grid(e, t) {
      ...
      for (let {
        ...
        of r) "+" === e && (n.scale = i), "*" === e && (n.rotate = i), "~" === e && (n.translate = i), "/" === e && (void 0 === n.size ? n.size = this.size(i, t) : n.fill = i), "|" !== e && "-" != e && "" != e || n.grid || (n.grid = Me(i, t.max_grid), "|" === e && (n.flexColumn = !0), "-" === e && (n.flexRow = !0));
      return n
    },
    gap: e => e,
    seed: e => e,
    shape: ot("shape-property", (e => {
      let [t, ...n] = L(e);
      if ("function" != typeof jt[t]) return "";
      let r = "clip-path";
      return Jt(r, `${r}:polygon(${jt[t](...n).join(",")});`) + "overflow:hidden;"
    })),
    use(e) {
  ...
  var rn = {
      ...
      nth: ({
        count: e,
        grid: t
      }) => (...n) => n.some((n => tn[n] ? tn[n](e) : nn(n, e, t.count))),
      row: ({
        y: e,
        grid: t
      }) => (...n) => n.some((n => tn[n] ? tn[n](e) : nn(n, e, t.y))),
      col: ({
        x: e,
        grid: t
      }) => (...n) => n.some((n => tn[n] ? tn[n](e) : nn(n, e, t.x))),
      even: ({
        count: e,
        grid: t,
        x: n,
  ...
  function fn(e, t, n) {
    var r = [],
      i = vn(gn((t = 1 == t ? {
        entropy: !0
      } : t || {}).entropy ? [e, yn(ln)] : null == e ? function() {
        try {
          var e;
          return e = new Uint8Array(an), (sn.crypto || sn.msCrypto).getRandomValues(e), yn(e)
        } catch (e) {
          var t = sn.navigator,
            n = t && t.plugins;
          return [+new Date, sn, n, sn.screen, yn(ln)]
        }
      }() : e, 3), r),
      s = new mn(r),
      o = function() {
        for (var e = s.g(6), t = un, n = 0; e < cn;) e = (e + n) * an, t *= an, n = s.g(1);
        for (; e >= hn;) e /= 2, t /= 2, n >>>= 1;
        return (e + n) / t
      };
    ...
    }, o.double = o, vn(yn(s.S), ln), (t.pass || n || function(e, t, n, r) {
      return r && (r.S && dn(r, s), e.state = function() {
        return dn(s, {})
      }), n ? (on.random = e, t) : e
    })(o, i, "global" in t ? t.global : this == on, t.state)
  }
  ...
  function mn(e) {
    var t, n = e.length,
      ...
      s = r.i = r.j = 0,
      o = r.S = [];
    for (n || (e = [n++]); i < an;) o[i] = i++;
    for (i = 0; i < an; i++) o[i] = o[s = pn & s + e[i % n] + (t = o[i])], o[s] = t;
    (r.g = function(e) {
      for (var t, n = 0, i = r.i, s = r.j, o = r.S; e--;) t = o[i = pn & i + 1], n = n * an + o[pn & (o[i] = o[s = pn & s + t]) + (o[s] = t)];
  ...
  function vn(e, t) {
    for (var n, r = e + "", i = 0; i < r.length;) t[pn & i] = pn & (n ^= 19 * t[pn & i]) + r.charCodeAt(i++);
    return yn(t)
  }
  ...
  vn(on.random(), ln);
  const wn = {};
  for (let e of Object.getOwnPropertyNames(Math)) wn[e] = () => (...t) => "number" == typeof Math[e] ? Math[e] : (t = t.map((e => it(j(e)))), Math[e](...t));
  class $n {
    constructor(e) {
      this.tokens = e, this.rules = {}, this.props = {}, this.keyframes = {}, this.grid = null, this.seed = null, this.is_grid_defined = !1, this.is_gap_defined = !1, this.coords = [], this.doodles = {}, this.canvas = {}, this.pattern = {}, this.shaders = {}, this.reset(), this.custom_properties = {}, this.uniforms = {}, this.content = {}
    }
    reset() {
      this.styles = {
        host: "",
    ...
    add_rule(e, t) {
      let n = this.rules[e];
      n || (n = this.rules[e] = []), n.push.apply(n, K(t))
    }
    pick_func(e) {
      return Ft[e] || wn[e]
    }
    apply_func(e, t, n) {
      ...
      return n.forEach((e => {
        let t = typeof e.value,
          n = "number" === t || "string" === t;
        if (!e.cluster && n) i.push(...L(e.value, {
          noSpace: !0
        }));
      ...
      })), i = i.filter((e => !_(e) && String(e).trim().length)), "function" == typeof r ? r(...K(i)) : r
    }
    compose_aname(...e) {
      return e.join("-")
    }
        ...
        if ("func" === e.type) {
          ...
          if ("function" == typeof i) {
            if (this.check_uniforms(r), this.is_composable(r)) {
              let n, i = j((e.arguments[0] || [])[0]);
              if ("doodle" === r && /^\d/.test(i) && (n = i, i = j((val.arguments[1] || [])[0])), !_(i)) switch (r) {
                case "doodle":
            ...
            case "func": {
              ...
              if ("function" == typeof s)
                if (this.check_uniforms(i), this.is_composable(i)) {
                  let n, s = j((r.arguments[0] || [])[0]);
                  if ("doodle" === i && /^\d/.test(s) && (n = s, s = j((r.arguments[1] || [])[0])), !_(s)) switch (i) {
                    case "doodle":
                      e += this.compose_doodle(this.inject_variables(s, t.count), n);
                      break;
                    case "shaders":
                      e += this.compose_shaders(s, t);
                      break;
                    case "pattern":
                      e += this.compose_pattern(s, t);
                      break;
                    case "canvas":
                      e += this.compose_canvas(s, r.arguments.slice(1))
                  }
                }
              else {
    ...
    add_grid_style({
      ...
      e && this.add_rule(":host", `background-color:${e};`), t || this.add_rule(":host", "contain:none;"), n && this.add_rule(":container", `rotate:${n};`), r && this.add_rule(":container", `scale:${r};`), i && this.add_rule(":container", `translate:${i};`), s && (this.add_rule(":container", "display:flex"), this.add_rule("cell", "flex:1")), o && (this.add_rule(":container", "display:flex;flex-direction:column;"), this.add_rule("cell", "flex:1"))
    }
    compose_rule(e, t, n) {
      ...
      if (/^animation(\-name)?$/.test(s)) {
        if (this.props.has_animation = !0, xn(n)) {
          let e = Pt[s];
          e && l && (l = e + "," + l)
        }
        if (i.count > 1) {
      ...
      "content" === s && (/["']|^none\s?$|^(var|counter|counters|attr|url)\(/.test(l) || (l = `'${l}'`)), "transition" === s && (this.props.has_transition = !0);
      let a = `${s}:${l};`;
      if (a = Jt(s, a), "clip-path" === s && (a += ";overflow:hidden;"), "width" !== s && "height" !== s || _n(n) || (a += `--internal-cell-${s}:${l};`), /^(background|background\-image)$/.test(s) && /\$\{(canvas|shader|pattern)/.test(l) && (a += "background-size:100% 100%;"), /^\-\-/.test(s)) {
        let e = t.count;
        bn(n) && (e = "container"), xn(n) && (e = "host"), this.custom_properties[e] || (this.custom_properties[e] = {}), this.custom_properties[e][s] = l
      }
      if (/^@/.test(s) && en[s.substr(1)]) {
        let t = s.substr(1),
          o = en[t](l, {
            is_special_selector: _n(n),
            grid: i.grid,
            max_grid: i.max_grid,
            extra: r
          });
        switch (t) {
          case "grid":
            xn(n) ? (a = o.size || "", this.add_grid_style(o)) : (a = "", this.is_grid_defined || (o = en[t](l, {
            ...
            break;
          case "gap":
            a = "", this.is_gap_defined || (this.add_rule(":container", `gap:${o};`), this.is_gap_defined = !0);
            break;
          case "content":
            a = "", void 0 === o || /\:before|\:after/.test(n) || bn(n) || (this.content[this.compose_selector(i)] = function(e) {
    ...
    pre_compose(e, t) {
      _(this.seed) && ((t || this.tokens).forEach((e => {
        if ("rule" === e.type && "@seed" === e.property && (this.seed = this.get_raw_value(e)), "pseudo" === e.type && xn(e.selector))
          for (let t of K(e.styles)) "rule" === t.type && "@seed" === t.property && (this.seed = this.get_raw_value(t))
        ...
        switch (t.type) {
          case "rule":
            ...
            break;
          case "pseudo":
            xn(t.selector) && (t.styles || []).forEach((t => {
              this.pre_compose_rule(t, e)
            }))
        }
      }))
    ...
    compose(e, t, n) {
      this.coords.push(e), (t || this.tokens).forEach(((t, r) => {
        ...
        switch (t.type) {
          ...
          case "keyframes":
            this.keyframes[t.name] || (this.keyframes[t.name] = e => `\n ${Q(t.steps.map((t=>`\n ${t.name}{${Q(t.styles.map((t=>this.compose_rule(t,e))))}}`)))}`)
        }
      }))
    }
    output() {
      for (let [e, t] of Object.entries(this.rules))
        if (bn(e)) this.styles.container += `\n .container{${Q(t)}}`;
        else {
          let n = xn(e) ? "host" : "cells",
            r = Q(t).trim(),
            i = "host" === n ? `${e}, .host` : e;
          this.styles[n] += `${i}{${r}}`
        } return this.uniforms.time && (this.styles.container += `\n:host, .host{animation:${Pt.animation};}`, this.styles.keyframes += `\n @keyframes ${Pt["animation-name"]}{from{--${Pt.name}:0} to{--${Pt.name}:${Pt["animation-duration"]/10}}}`), this.coords.forEach(((e, t) => {
  ...
  function kn(e, t, n, r, i) {
    ...
    function a(e = 0, t) {
      return 1 == arguments.length && ([e, t] = [0, e]), C(o(), e, t)
    }
    ...
    if (h && (t = h), p ? (p = String(p), o = fn(p)) : p = n, _(p) && (p = Date.now(), o = fn(p)), p = String(p), s.seed = p, s.random = o, s.reset(), 1 == t.z)
  ...
  function Tn(e, t, n, r) {
    ...
    let a = jn(e.fragment || "", "uniform vec2 u_resolution;");
    a = jn(a, "uniform float u_time;"), a = jn(a, "uniform float u_timeDelta;"), a = jn(a, "uniform int u_frameIndex;"), a = jn(a, "uniform vec2 u_seed;"), e.textures.forEach((e => {
    ...
    if (m || g || d) {
      let t = 0,
        n = 0;
      return Promise.resolve(st.set(e, (e => (l.clear(l.COLOR_BUFFER_BIT), m && l.uniform1f(m, e / 1e3), d && l.uniform1i(d, t++), g && (l.uniform1f(g, (n - e) / 1e3), n = e), l.drawArrays(l.TRIANGLES, 0, 6), s.toDataURL()))))
    }
    return l.drawArrays(l.TRIANGLES, 0, 6), Promise.resolve(st.set(e, s.toDataURL()))
  }
  ...
  function An(e, t) {
    ...
    return n.length && (t.value = Rn(n)), t
  }
  ...
  function En(e, t) {
    ...
    for (; e.next();) {
      ...
      } else l.isSymbol(";") ? n.length && r.length && (n[n.length - 1].value += ";" + Rn(r), r = []) : (l.isSymbol("(") && s.push(l), l.isSymbol(")") && s.pop(), r.push(l))
    }
  ...
  function Cn(e, t) {
    if ("fill" === e.name) {
      ...
      return {
        type: "statement",
        value: `\ncolor = vec4(${zn(n/255)}, ${zn(r/255)}, ${zn(i/255)}, ${zn(s)});`
      }
    }
    return "grid" == e.name ? {
      type: "grid",
  ...
  function Mn(e, t) {
    ...
    return n.forEach((e => {
        if ("statement" === e.type) {
          let n = Cn(e, t);
          "statement" == n.type && r.push(n.value), "grid" === n.type && (i = M(n.value))
  ...
  function On(e) {
    ...
    return Promise.resolve(st.set(e, `paint(${n})`))
  }
  ...
  if ("undefined" != typeof customElements) {
    class e extends HTMLElement {
      ...
      update(e) {
        this.cleanup(), e || (e = E(this._innerHTML)), this._innerHTML !== e && (this._innerHTML = e), this.grid_size || (this.grid_size = this.get_grid());
        const {
          x: t,
          y: n,
          z: r
        ...
        if (Object.assign(this.grid_size, l), h) return o.grid ? this.build_grid(o, l) : this.build_grid(this.generate(ze(i + e, this.extra)), l);
        ...
        this.set_content(".style-keyframes", p(o.styles.keyframes)), o.props.has_animation && (this.set_content(".style-cells", ""), this.set_content(".style-container", "")), setTimeout((() => {
          this.set_content(".style-container", p(Bn(this.grid_size) + o.styles.host + o.styles.container)), this.set_content(".style-cells", p(o.styles.cells))
        }))
      }
      get grid() {
      ...
      get_grid() {
        return Me(this.attr("grid"), this.get_max_grid())
      }
      get_use() {
      ...
      generate(e) {
        ...
        _(n) && (n = Date.now());
        let r = this.compiled = kn(e, t, n, this.get_max_grid());
      ...
      doodle_to_image(e, t, n) {
        ...
        let r = ze(e = ":doodle{width:100%;height:100%}" + e, this.extra),
          i = Me(""),
          s = kn(r, i, this._seed_value, this.get_max_grid(), this._seed_random),
          o = s.grid ? s.grid : i;
        const {
          keyframes: l,
          host: a,
        ...
        if (t && t.arg) {
          let e = M(t.arg);
          e.x && e.y && (h = `viewBox="0 0 ${e.x} ${e.y}"`)
        }
        let p = this.replace(s),
          f = Hn(o, s.content);
        p(`\n<svg ${t&&t.width&&t.height?`width="${t.width}" height="${t.height}"`:""} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" ${h}><foreignObject width="100%" height="100%"><div class="host" width="100%" height="100%" xmlns="http://www.w3.org/1999/xhtml"><style>${Un()} ${Bn(o)} ${a} ${u} ${c} ${l}</style><svg id="defs" xmlns="http://www.w3.org/2000/svg" style="width:0;height:0"></svg>${f}</div></foreignObject></svg>`).then((e => {
      ...
      shader_to_image({
        ...
        let s = "string" == typeof e ? function(e) {
            ...
            for (; i.next();) {
              ...
              else $(n) || n == e.pos[1] || (o.push(Oe()), n = null), t && t.startsWith("texture") || e.isWord() && e.value.startsWith("#") && (o.push(Oe()), n = r.pos[1]), o.push(e)
            }
            return $(l.fragment) && (l.fragment = We(o), l.textures = l.textures || []), l
          }(e) : e,
            ...
            if ("function" == typeof e) {
              let t = function(e) {
                ...
                function o(s) {
                  n || (n = s), e(n);
                  let l = s - r;
                  l < Wn && (l = Wn), l > 1e3 && (l = i || 1e3), r && (n += l), i = l, r = s, t = requestAnimationFrame(o)
                }
        ...
        if (!s.textures.length || s.ticker) Tn(s, c, h, l).then(u).then(i);
        else {
          ...
          Promise.all(e).then((e => {
            s.textures = e, Tn(s, c, h, l).then(u).then(i)
          }))
        }
      }
      load(e) {
        this.cleanup();
        let t = ze(this.get_use() + E(this.innerHTML), this.extra),
          n = this.generate(t);
        e || this.hasAttribute("click-to-update") && this.addEventListener("click", (e => this.update())), this.grid_size = n.grid ? n.grid : this.get_grid(), this.build_grid(n, this.grid_size), this._innerHTML = this.innerHTML, this.innerHTML = ""
      }
      replace({
        doodles: e,
        shaders: t,
      ...
      build_grid(e, t) {
        ...
        this.doodle.innerHTML = `\n<style>${Un()}</style><style class="style-keyframes">${s}</style><style class="style-container">${u}</style><style class="style-cells">${c}</style><svg id="defs" xmlns="http://www.w3.org/2000/svg" style="width:0;height:0"></svg>${Hn(t,p)}`, this.set_content(".style-container", f(u)), i ? setTimeout((() => {
  ...
  function Un() {
    ...
    const t = Yt(/grid/).map((e => `${e}:inherit;`)).join("");
  ...
  function Fn(e, t, n, r, i = "") {
    let s = S(e, t, n);
    return `<cell id="${s}">${Dn(r["#"+s])}${Dn(i)}</cell>`
  }
  ...
  function Hn(e, t) {
    ...
    if (1 == i)
      for (let e = 1; e <= r; ++e)
        for (let r = 1; r <= n; ++r) s += Fn(r, e, 1, t);
    else {
      let e = "";
      for (let n = i; n >= 1; n--) {
        e = Fn(1, 1, n, t, e)
